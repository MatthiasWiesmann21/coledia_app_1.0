...
export default async function UpgradePage({
  ...
  const hasFeatureKey =
    featureKey && ["quizzesCertificates", "liveEvents", "userGroups", "auditLogs", "sellCourses", "apiAccess", "customPages"].includes(featureKey);
  const requiredPlan = hasFeatureKey ? minPlanForFeature(featureKey) : null;
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 p-6 text-center">
      ...
      <div className="max-w-md space-y-2">
        ...
        {hasFeatureKey && requiredPlanName ? (
